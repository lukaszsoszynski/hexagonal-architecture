...
@Component
class ThreadModelConverter implements Converter<Thread, com.impaqgroup.training.architecture.hexagonalarchitecture.soap.Thread> {
    @Override
    public com.impaqgroup.training.architecture.hexagonalarchitecture.soap.Thread convert(Thread thread) {
        ...
        result.setForum(thread.getForumName());
        result.setCreator(thread.getCreatorEmail());
        return result;
    }
}
